        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h3>Edit Product
                        <a href="{{url('admin/products')}}" class="btn btn-danger btn-sm text-white float-start">
                            BACK
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="checkbox" name="trending"  {{$product->trending == '1' ? 'checked':''}}  class="form-control" style="width: 50px; height: 50px">
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="mb-3">
                                            <label>Status</label>
                                            <input type="checkbox" name="status" value="{{$product->status == '1' ? 'checked':''}}"  class="form-control" style="width: 50px; height: 50px">
                                        </div>
